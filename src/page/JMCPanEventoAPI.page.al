page 53117 "JMC Pan Evento API"
{
    APIVersion = 'v1.0';
    APIPublisher = 'juanMariaCorzo';
    APIGroup = 'events';

    EntityCaption = 'Event Bread', Comment = 'ESP="Pan Evento"';
    EntitySetCaption = 'Event Breads', Comment = 'ESP="Pan Eventos"';
    EntityName = 'eventBread';
    EntitySetName = 'eventBreads';

    PageType = API;
    SourceTable = "Productos Evento";
    SourceTableView = where(Tipo = const(Pan));
    DelayedInsert = true;
