page 53120 "JMC Personal Evento API"
{
    APIVersion = 'v1.0';
    APIPublisher = 'juanMariaCorzo';
    APIGroup = 'events';

    EntityCaption = 'Event Staff', Comment = 'ESP="Personal Evento"';
    EntitySetCaption = 'Event Staff', Comment = 'ESP="Personal Eventos"';
    EntityName = 'eventStaff';
    EntitySetName = 'eventStaff';

    PageType = API;
    SourceTable = "Recursos Evento";
    SourceTableView = where(Tipo = const(Personal));
    DelayedInsert = true;
