page 53134 "JMC Res Assignment API Simp"
{
    APIVersion = 'v1.0';
    APIPublisher = 'juanMariaCorzo';
    APIGroup = 'recursos';

    EntityCaption = 'Asignación de Recursos Simple';
    EntitySetCaption = 'Asignaciones de Recursos Simple';
    EntityName = 'asignacionRecursosSimple';
    EntitySetName = 'asignacionesRecursosSimple';
