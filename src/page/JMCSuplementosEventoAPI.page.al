page 53119 "JMC Suplementos Evento API"
{
    APIVersion = 'v1.0';
    APIPublisher = 'juanMariaCorzo';
    APIGroup = 'events';

    EntityCaption = 'Event Supplement', Comment = 'ESP="Suplemento Evento"';
    EntitySetCaption = 'Event Supplements', Comment = 'ESP="Suplementos Evento"';
    EntityName = 'eventSupplement';
    EntitySetName = 'eventSupplements';

    PageType = API;
    SourceTable = "Productos Evento";
    SourceTableView = where(Tipo = const(Suplementos));
    DelayedInsert = true;
