table 53110 "JMC Cronus"
{
    ...
    fields
    {
        ...
        field(18; "JMC Resource No."; Code[20])
        {
    ...
    begin
        ...
        "JMC Customer Type" := jmcAnalysisJournalLine."JMC Customer Type";
        ...
        "JMC Resource No." := jmcAnalysisJournalLine."JMC Resource No.";
        "JMC Resource Name" := jmcAnalysisJournalLine."JMC Resource Name";
        "JMC Cost Type" := jmcAnalysisJournalLine."JMC Cost Type";
